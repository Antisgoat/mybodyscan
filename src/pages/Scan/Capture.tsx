...
import ScanCaptureComponent, {
  type CaptureReady,
} from "@/features/scan/ScanCapture";
...
export default function ScanCapture() {
  ...
  const handleContinue = () => {
    ...
    try {
      ...
      (Object.keys(READY_KEY_TO_VIEW) as Array<keyof CaptureReady>).forEach(
        (pose) => {
  ...
  return (
    <div className="space-y-6">
      <Seo
        title="Capture Photos – MyBodyScan"
        description="Upload the four required angles for your scan."
      />
      <Card>
        <CardHeader>
