...
import { getDailyLog } from "@app/lib/nutrition.ts";
import { getPlan } from "@app/lib/workouts.ts";
...
import { DEMO_NUTRITION_LOG, DEMO_WORKOUT_PROGRESS } from "@app/lib/demoContent.ts";
import { useUserProfile, type CoachPlan, type CoachProfile } from "@app/hooks/useUserProfile.ts";
import { track } from "@app/lib/analytics.ts";
import { startScan } from "@app/lib/scan.ts";
