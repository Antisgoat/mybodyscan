  ...
  return (
    <>
      ...
      <article className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <p>
          We collect your account email and user media (photos/videos) solely to
          provide estimates such as body fat %, weight, and BMI. Your data is
          stored securely, never sold, and retained only as needed to operate
          the service.
        </p>
        <p>
