...
describe("normalizeFoodItem", () => {
  it("maps USDA-like shape", () => {
    const raw = { fdcId: 123, description: "Chicken, breast", nutrients: { energyKcal: 165, protein: 31, fat: 3.6, carbohydrates: 0 } };
  ...
  it("maps OFF-like shape", () => {
    const raw = { code: "0123456", product_name: "Oatmeal", nutriments: { energy_kcal: 150, proteins: 5, fat: 3, carbohydrates: 27 } };
    const n = normalizeFoodItem(raw);
