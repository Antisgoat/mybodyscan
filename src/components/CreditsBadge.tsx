...
export function CreditsBadge() {
  const { credits, unlimited, loading, demo, tester, role } = useCredits();
  const isDev = role === "dev";
  const showInfinity = unlimited || isDev;
  const displayCredits = loading ? "…" : showInfinity ? "∞" : credits;
