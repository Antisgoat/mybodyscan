export const I18N_DICTIONARY = {
  en: {
    ...
    "today.noCalorieTarget":
      "Set a calorie target in Coach to personalize this goal.",
    ...
    // Legal
    "legal.consent":
      "By continuing, you agree to our Terms, Privacy Policy, and Disclaimer",
    "legal.notMedicalAdvice":
