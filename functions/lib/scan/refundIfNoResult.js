...
async function handler(req, res) {
    ...
    const body = req.body;
    const scanId = body?.scanId || req.query?.scanId;
    if (!scanId) {
...
export const refundIfNoResult = onRequest({ invoker: "public" }, withCors(async (req, res) => {
    try {
...
//# sourceMappingURL=refundIfNoResult.js.map