  ...
  const analysis = buildAnalysisFromResult({
    estimate: {
      ...
      visualProportions: {
        ...
        hipDepthToHeight: 0.18,
        armLengthToHeight: 0.34,
        calfWidthToHeight: 0.055,
        legLengthToHeight: 0.5,
        torsoLengthToHeight: 0.33,
        neckWidthToHeight: 0.085,
        headWidthToHeight: 0.13,
        armWidthToHeight: 99,
        confidence: 0.82,
      },
    },
