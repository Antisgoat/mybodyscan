...
- User-generated media uploads use signed URLs targeting `uploads/{uid}/{scanId}/{pose}.jpg` before results persist to Storage under `scans/{uid}/{scanId}/…`, with Storage rules limiting owners to <50 MB images/videos.【F:functions/src/scan/start.ts†L46-L116】【F:src/lib/scan.ts†L40-L79】【F:storage.rules†L13-L29】
